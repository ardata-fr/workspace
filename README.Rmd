...
`workspace` gives you the tools to create, store, read and manage structured collections of datasets and other objects using a 'workspace', then bundle it into a compressed archive (zip). 
...
- Generation of structured archives:
  ...
  - Supports geosptial data in geopackage format for vector or polygon data, and
  tiff format for raster data.
